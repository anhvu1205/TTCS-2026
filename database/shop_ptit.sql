...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 07, 2026 lúc 04:40 AM
...
(2, 4, 28, 1, 1280000.00, 1280000.00, 'S', 'Navy Blue');
...
(4, 2, NULL, 'Anh Vũ Trần Lê', NULL, '0915085807', '4545', 1280000.00, 0.00, 'COD', 'DA_GIAO_HANG', '2026-05-05 03:28:12');
...
(28, 7, 3, 'Áo len Zara', 'Áo len Polo cổ tay Zara', 1280000.00, 27, 'S,M,L,XL', 'Navy Blue', 'Cotton, Polyester', 'https://static.zara.net/assets/public/7f3d/981f/a95a48fda38b/12e72a1415da/00526310401-a1/00526310401-a1.jpg?ts=1754995160359&w=1125', 65);
...
--
ALTER TABLE `chitietdonhang`
  MODIFY `maCTDH` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `donhang`
  MODIFY `maDH` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
